...
class batchMatPolyZonotope():
    ...
    def __getitem__(self,idx):
        ...
        if len(Z.shape) > 3:
            ...
            return conSet.matPolyZonotope(Z,self.n_dep_gens,self.expMat,self.id,compress=0)
    @property 
    ...
    def __matmul__(self,other):
        ...
        if isinstance(other, torch.Tensor):
            ...
            if len(other.shape) == 1:
                Z = self.Z @ other
                return conSet.batchPolyZonotope(Z,self.n_dep_gens,self.expMat,self.id,compress=1)
        ...
        elif isinstance(other,(conSet.batchPolyZonotope,conSet.polyZonotope)):
            ...
            return conSet.batchPolyZonotope(Z,n_dep_gens,expMat,id)

        elif isinstance(other,(batchMatPolyZonotope,conSet.matPolyZonotope)):
    ...
    def __rmatmul__(self,other):
        ...
        if isinstance(other,torch.Tensor):
            ...
            Z = other @ self.Z
            return batchMatPolyZonotope(Z,self.n_dep_gens,self.expMat,self.id,compress=1)
        elif isinstance(other,conSet.matPolyZonotope):
    ...
    def to_batchMatZonotope(self):
        if self.n_dep_gens != 0:
            ...
            Z = self.Z
        return conSet.batchMatZonotope(Z)
